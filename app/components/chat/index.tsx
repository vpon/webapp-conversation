  ...
  const renderFeedbackRating = (rating: MessageRating | undefined) => {
    ...
    return (
      <Tooltip
        ...
        content={`${t('common.operation.cancel')}${isLike ? t('common.operation.like') : t('common.operation.dislike')}`}
      >
        <div
  ...
  return (
    <div className='flex items-start justify-end' key={id}>
      ...
      {useCurrentUserAvatar
        ? (
          <div className='w-10 h-10 shrink-0 leading-10 text-center mr-2 rounded-full bg-primary-500 text-white'>
